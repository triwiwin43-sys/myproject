      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b">
              <div className="flex items-center justify-between">
                ...
                <Link to="/orders" className="text-blue-600 hover:text-blue-700 text-sm">Lihat Semua</Link>
              </div>
            </div>
            <div className="p-6">
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link to="/orders" className="flex flex-col items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
              <FiShoppingCart className="w-8 h-8 text-green-600 mb-2" />
              <span className="text-sm font-medium text-green-900">Kelola Pesanan</span>
            </Link>
            <Link to="/services" className="flex flex-col items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
              <FiSettings className="w-8 h-8 text-purple-600 mb-2" />
            ...
            <Link to="/profile" className="flex flex-col items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
              <FiUsers className="w-8 h-8 text-yellow-600 mb-2" />
              <span className="text-sm font-medium text-yellow-900">Profil Toko</span>
            </Link>
          </div>
        </div>
      </div>
